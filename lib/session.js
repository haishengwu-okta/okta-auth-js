 ...
 */
// @flow
import type { OktaAuth, AuthConfig } from './types';

var util = require('./util');
var http = require('./http');

function sessionExists(sdk /*: AuthConfig */) {
...
function getSession(sdk /*: OktaAuth */) {
...
function closeSession(sdk /*: OktaAuth */) {
...
function refreshSession(sdk /*: OktaAuth */) {
  return http.post(sdk, '/api/v1/sessions/me/lifecycle/refresh');
}

function setCookieAndRedirect(sdk /*: OktaAuth */, sessionToken /*: string */, redirectUrl /*: string */) {
