 ...
 */
// @flow
import type { OAuthParams, OktaAuth, TokenObject, OAuthUserOptions, ValidateClaimOption } from './types';
...
function verifyToken(sdk /*: OktaAuth */, token /*: TokenObject */, validationParams /*: ValidateClaimOption */) {
  return new Q()
  .then(function() {
...
function convertOAuthParamsToQueryParams(oauthParams /*: OAuthParams */) {
  // Quick validation
  ...
  return util.removeNils(oauthQueryParams);
}
...
function getToken(sdk /*: OktaAuth */, oauthOptions /*: OAuthParams */, options /*: OAuthUserOptions */) {
  oauthOptions = oauthOptions || {};
  options = options || {};

  // Default OAuth query params
  var oauthParams /*: OAuthParams */ = getDefaultOAuthParams(sdk, oauthOptions);
  ...
  function getOrigin(url) {
    ...
    var regResult = originRegex.exec(url);
    if (regResult) {
      return regResult[0];
    } else {
      return '';
  ...
  switch (flowType) {
    case 'IFRAME':
      ...
      return iframePromise
        ...
        .fin(function() {
          if (document.body && document.body.contains(iframeEl) && iframeEl && iframeEl.parentElement) {
...
function getWithoutPrompt(sdk /*: OktaAuth */, oauthOptions /*: OAuthParams */, options /*: OAuthUserOptions */) {
...
function getWithPopup(sdk /*: OktaAuth */, oauthOptions /*: OAuthParams */, options /*: OAuthUserOptions */) {
  var oauthParams = util.clone(oauthOptions) || {};
  util.extend(oauthParams, {
    display: 'popup'
  });
...
function getWithRedirect(sdk /*: OktaAuth */, oauthOptions /*: OAuthParams */, options /*: OAuthUserOptions */) {
  oauthOptions = util.clone(oauthOptions) || {};
...
function renewToken(sdk /*: OktaAuth */, token /*: TokenObject */) {
...
function parseFromUrl(sdk /*: OktaAuth */, url /*: string */) {
  var nativeLoc = sdk.token.parseFromUrl._getLocation();
...
function getUserInfo(sdk /*: OktaAuth*/, accessTokenObject /*: TokenObject */) {
