...
import type { HttpRequestOption, AuthConfig, OktaAuth } from './types';
...
function OktaAuthBuilder(args) {
  ...
  this.options = {
    ...
    maxClockSkew: config.DEFAULT_MAX_CLOCK_SKEW
  };
...
*/
proto.fingerprint = function(options /*: FingerPrintOption */) {
  options = options || {};
  var sdk /*: OktaAuth */ = this;
  ...
  return deferred.promise.fin(function() {
    ...
    if (document.body && document.body.contains(iframe) && iframe.parentElement) {
      iframe.parentElement.removeChild(iframe);
    }
  });
};

module.exports = function(ajaxRequest /*: HttpRequestOption */) {
  function OktaAuth(args /*: AuthConfig */) {
    ...
    OktaAuthBuilder.apply(this, args);
  }
